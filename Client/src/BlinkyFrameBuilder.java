...
public class BlinkyFrameBuilder {
    ...
    public BlinkyFrameBuilder withSpecificLightsSetTo(Map<Integer, Color> lightToColorMappings) {
        for (Map.Entry<Integer, Color> entry : lightToColorMappings.entrySet()) {
            this.lights[entry.getKey()] = entry.getValue();
        }
        return this;
    }

    public BlinkyFrameBuilder withSpecificLightSetTo(Integer specificLight, Color color) {
        this.lights[specificLight] = color;
        return this;
    }
